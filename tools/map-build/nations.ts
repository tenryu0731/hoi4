...
export interface NationDef {
  ...
  resources: Partial<Record<'oil' | 'steel' | 'aluminium' | 'tungsten' | 'rubber' | 'chromium', number>>;
...
export const NATIONS: NationDef[] = [
  {
    ...
    color: [0x5a, 0x62, 0x6b], capital: 'Berlin', capitalLonLat: [13.4, 52.52],
  ...
  },
  {
    ...
    color: [0xa8, 0x2f, 0x2f], capital: 'Moscow', capitalLonLat: [37.62, 55.75],
  ...
  },
  {
    ...
    color: [0x8a, 0x4a, 0x3e], capital: 'London', capitalLonLat: [-0.13, 51.51],
  ...
  },
  {
    ...
    color: [0x36, 0x63, 0x99], capital: 'Paris', capitalLonLat: [2.35, 48.86],
  ...
  },
  {
    ...
    color: [0x4d, 0x7a, 0x52], capital: 'Rome', capitalLonLat: [12.5, 41.9],
  ...
  },
  {
    ...
    color: [0xb0, 0x6a, 0x8c], capital: 'Warsaw', capitalLonLat: [21.01, 52.23],
  ...
  },
  {
    ...
    color: [0x7f, 0x6f, 0xa8], capital: 'Prague', capitalLonLat: [14.42, 50.09],
  ...
  },
  {
    ...
    color: [0x6f, 0x9b, 0x8a], capital: 'Belgrade', capitalLonLat: [20.46, 44.82],
  ...
  },
  {
    ...
    color: [0xc2, 0x92, 0x4a], capital: 'Bucharest', capitalLonLat: [26.1, 44.44],
  ...
  },
  {
    ...
    color: [0x8e, 0x5b, 0x3a], capital: 'Budapest', capitalLonLat: [19.04, 47.5],
  ...
  },
  {
    ...
    color: [0xd0, 0xb0, 0x8a], capital: 'Vienna', capitalLonLat: [16.37, 48.21],
  ...
  },
  {
    ...
    color: [0x5f, 0x7d, 0x4a], capital: 'Sofia', capitalLonLat: [23.32, 42.7],
  ...
  },
  {
    ...
    color: [0x4a, 0x8c, 0xb0], capital: 'Athens', capitalLonLat: [23.73, 37.98],
  ...
  },
  {
    ...
    color: [0x9a, 0x3f, 0x3f], capital: 'Tirana', capitalLonLat: [19.82, 41.33],
  ...
  },
  {
    ...
    color: [0xb5, 0x5a, 0x4a], capital: 'Ankara', capitalLonLat: [32.86, 39.93],
  ...
  },
  {
    ...
    color: [0xc9, 0xa2, 0x3c], capital: 'Madrid', capitalLonLat: [-3.7, 40.42],
  ...
  },
  {
    ...
    color: [0x3f, 0x7a, 0x5e], capital: 'Lisbon', capitalLonLat: [-9.14, 38.72],
  ...
  },
  {
    ...
    color: [0xc4, 0x4a, 0x4a], capital: 'Bern', capitalLonLat: [7.45, 46.95],
  ...
  },
  {
    ...
    color: [0xd6, 0xb8, 0x4a], capital: 'Brussels', capitalLonLat: [4.35, 50.85],
  ...
  },
  {
    ...
    color: [0xe0, 0x8c, 0x3a], capital: 'Amsterdam', capitalLonLat: [4.9, 52.37],
  ...
  },
  {
    ...
    color: [0x6a, 0xa8, 0xc4], capital: 'Luxembourg', capitalLonLat: [6.13, 49.61],
  ...
  },
  {
    ...
    color: [0xc4, 0x5a, 0x6a], capital: 'Copenhagen', capitalLonLat: [12.57, 55.68],
  ...
  },
  {
    ...
    color: [0x4a, 0x6a, 0xa8], capital: 'Oslo', capitalLonLat: [10.75, 59.91],
  ...
  },
  {
    ...
    color: [0x3a, 0x8a, 0xa8], capital: 'Stockholm', capitalLonLat: [18.07, 59.33],
  ...
  },
  {
    ...
    color: [0x8a, 0xa8, 0xc4], capital: 'Helsinki', capitalLonLat: [24.94, 60.17],
  ...
  },
  {
    ...
    color: [0x7a, 0x9a, 0x8a], capital: 'Tallinn', capitalLonLat: [24.75, 59.44],
  ...
  },
  {
    ...
    color: [0x9a, 0x6a, 0x5a], capital: 'Riga', capitalLonLat: [24.11, 56.95],
  ...
  },
  {
    ...
    color: [0x6a, 0x8a, 0x4a], capital: 'Kaunas', capitalLonLat: [23.9, 54.9],
  ...
  },
  {
    ...
    color: [0x4a, 0x9a, 0x5a], capital: 'Dublin', capitalLonLat: [-6.26, 53.35],
  ...
  },
  {
    ...
    color: [0x8a, 0xb8, 0xc8], capital: 'Reykjavik', capitalLonLat: [-21.94, 64.15],
